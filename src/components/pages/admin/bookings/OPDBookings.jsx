  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden">
      <div className="flex justify-between items-center mb-4 px-1 shrink-0">
        <div>
          <h1 className="text-[22px] md:text-[26px] font-semibold py-1 text-[#003d33] tracking-tighter uppercase leading-none">OPD Bookings</h1>
          <p className="text-gray-400 text-[9.5px] font-normal uppercase">Manage outpatient department consultations.</p>
        </div>
        <button className="bg-[#003d33] text-white px-4 py-1.5 rounded-full flex items-center gap-2 text-[11.5px] font-normal shadow-sm transition-all active:scale-95">
          <span className="text-[17px] leading-none">+</span> New OPD Booking
        </button>
      </div>
      ...
      <footer className="py-2 flex items-center justify-between shrink-0 px-1">
        <span className="text-[9px] font-normal text-gray-400 uppercase">Showing 1-{OPD_DATA.length} of {OPD_DATA.length} Bookings</span>
