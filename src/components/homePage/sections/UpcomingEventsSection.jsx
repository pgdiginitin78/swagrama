        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {eventsDataUpdated.map((event, i) => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 px-8 py-4 flex flex-col justify-end min-h-[50%]">
                <motion.div
                ...
                <div className="flex gap-3 opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500 ease-out">
                  <motion.button
                    className="flex-1 bg-white/10 backdrop-blur-lg border border-white/20 hover:bg-white/20 text-white py-2 rounded text-xs font-semibold uppercase tracking-wider transition-all"
                  ...
                  <motion.button
                    className="flex-1 bg-gradient-to-r from-green-500 to-lime-500 text-white py-2 rounded text-xs font-bold uppercase tracking-wider shadow-[0_0_20px_rgba(34,197,94,0.3)] hover:shadow-[0_0_25px_rgba(34,197,94,0.5)] transition-all"
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                    onClick={(e) => {
                      e.stopPropagation();
