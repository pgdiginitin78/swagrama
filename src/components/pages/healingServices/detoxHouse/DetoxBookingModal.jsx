...
const schema = yup.object().shape({
  ...
  stayType: yup.string().required("Please select stay type"),
  termsAccepted: yup
    .boolean()
...
console.log("selectedServiceValue",selectedServiceValue);
  ...
  useEffect(() => {
    ...
    setValue("totalAmount", days * price);
  }, [fromDate, toDate, selectedServiceValue, setValue]);
...
export default DetoxBookingModal;
