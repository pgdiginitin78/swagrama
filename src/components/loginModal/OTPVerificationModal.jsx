...
const OTPVerificationModal = ({ open, handleClose, onVerify, handleResend, phoneNumber = "+91 98XXX XXXXX" }) => {
              ...
              <div className="p-3 relative z-10">
                ...
                <div className="flex flex-col items-center text-center mb-3 mt-2">
                  ...
                  <p className="text-gray-500 text-xs leading-relaxed max-w-[220px]">
                    ...
                    <span className="block font-semibold text-green-600 mt-0.5 text-sm">{phoneNumber}</span>
                  </p>
                </div>
